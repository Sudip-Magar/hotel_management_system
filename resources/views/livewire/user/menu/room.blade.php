<div class="max-w-7xl mx-auto p-6" x-data="room">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <template x-for="(room, idx) in rooms">
            <a :href="'/room/room-detail/' + room.id" title="View Detail">
                <div
                    ...
                    <!-- Room Info -->
                    <div class="p-4">
                        <h2 class="text-xl font-semibold mb-1">Room Number: <span x-text="room.room_number"></span></h2>
                        ...
                        <p class="text-gray-600 mb-1">Price: Rs. <span class="font-medium" x-text="room.price"></span>
                        </p>
                    ...
                    bg-green-500">Available</span>
                        ...
                        <div class="flex flex-wrap gap-2 mb-2 text-gray-700">
                            ...
                            <span class="flex items-center gap-1">
                                🛋 Living Room: <span x-text="room.room_feature.has_living_room ? 'Yes' : 'No'"></span>
                            </span>
                        </div>
        ...
        <!-- Repeat Room Card for each room -->
    </div>
</div>
