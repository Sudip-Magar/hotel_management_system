<div class="max-w-3xl mx-auto mt-20 p-6 bg-white rounded-lg shadow-md" x-data="guestType">
            ...
            <tbody>
                ...
                <template x-if="!guestTypes || guestTypes.length === 0">
                    <tr class="text-center ">
                        <td class="py-20 text-2xl font-semibold text-gray-400" colspan="3">Currently there no Guest
                            Type.
                            Try creating one </td>
                    </tr>
                </template>
    ...
    <div x-show="showModal" x-transition.opacity x-cloak
        ...
        <div @click.outside = 'closeModel' class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
            ...
            <p class="text-gray-700 mb-6">
                Are you sure you want to delete the guest type "<span class="font-semibold"
