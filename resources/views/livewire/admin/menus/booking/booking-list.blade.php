        ...
        <tbody>
            <template x-for="booking in bookings" :key="booking.id">
                <tr class="hover:bg-gray-100 text-center">
                    ...
                    <td class="px-4 py-2 border-b" x-text="booking.check_in"></td>
                    <td class="px-4 py-2 border-b" x-text="booking.check_out"></td>
                    <td class="px-4 py-2 border-b" x-text="booking.total_nights"></td>
                    <td class="px-4 py-2 border-b" x-text="booking.total_price"></td>
                    <td class="px-4 py-2 border-b" x-text="booking.booking_status"></td>
                    <td class="px-4 py-2 border-b" x-text="booking.payment_status"></td>
                    <td class="px-4 py-2 border-b space-x-2">
                        <a class="cursor-pointer bg-blue-300 text-blue-700 hover:bg-blue-400 px-3 py-1 rounded">
