<div class="max-w-3xl mx-auto mt-20 p-6 bg-white rounded-lg shadow-md" x-data="createRoomCategory">
    ...
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Add Room Category</h2>
    ...
    <form @submit.prevent="registerCategory">
        ...
        <div class="mb-4">
            ...
            <textarea id="description" rows="4" x-model="data.description"
                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
